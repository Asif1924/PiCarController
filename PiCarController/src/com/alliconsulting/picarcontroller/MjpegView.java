...
public class MjpegView extends SurfaceView implements SurfaceHolder.Callback {
	...
	private long delay;
    private static final 	String 						LOG_TAG 				= "PiCarControllerActivity::MjpegView";
	...
	public class MjpegViewThread extends Thread {
		...
		public MjpegViewThread(SurfaceHolder surfaceHolder, Context context) {
	    	String methodName = "MjpegViewThread";
	    	Log.i(LOG_TAG + ": MjpegViewThread", methodName );
					...
					try {
						...
						synchronized (mSurfaceHolder) {
							try {
								...
								Log.i(LOG_TAG + "MjpegViewThread", methodName + ": IOException=" + e.getMessage());
								e.printStackTrace();
							} catch (Exception e) {
								Log.i(LOG_TAG + "MjpegViewThread", methodName + ": Exception=" + e.getMessage());
								e.printStackTrace();
							}
						}
					} finally {
	...
	public void setStream(MjpegInputStream mjpegStream) {
		mIn = mjpegStream;		
	}
}