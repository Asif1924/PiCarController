...
public class GStreamerInputStream extends DataInputStream {
    ...
    private static final String TAG="PiCarControllerActivity::GStreamerInputStream";
    ...
    public static GStreamerInputStream read(String surl) {
    	try {
    		URL url = new URL(surl);
    		HttpURLConnection urlConnection = (HttpURLConnection) url.openConnection();
    		return new GStreamerInputStream(urlConnection.getInputStream());
    	}catch(Exception e){}
    	
        return null;
    }
	
    public GStreamerInputStream(InputStream in) {
