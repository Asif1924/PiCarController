...
void Java_com_alliconsulting_picarcontroller_GStreamerInputStream_pixeltobmp(JNIEnv* env,jobject thiz, jbyteArray jp, jint l, jobject bmp);
void Java_com_alliconsulting_picarcontroller_GStreamerInputStream_freeCameraMemory(JNIEnv* env,jobject thiz);
